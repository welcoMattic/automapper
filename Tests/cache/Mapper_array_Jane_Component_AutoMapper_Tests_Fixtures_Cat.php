...
final class Mapper_array_Jane_Component_AutoMapper_Tests_Fixtures_Cat extends \Jane\Component\AutoMapper\GeneratedMapper
{
    ...
    public function &map($value, array $context = array())
    {
        ...
        if (null === $result) {
            $result = new \Jane\Component\AutoMapper\Tests\Fixtures\Cat();
        }
